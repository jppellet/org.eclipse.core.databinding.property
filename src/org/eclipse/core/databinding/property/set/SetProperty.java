...
public abstract class SetProperty<S, E> implements ISetProperty<S, E> {
	...
	public IObservableFactory<IObservableSet<E>, S> setFactory() {
		return new IObservableFactory<IObservableSet<E>, S>() {
	...
	public IObservableFactory<IObservableSet<E>, S> setFactory(final Realm realm) {
		return new IObservableFactory<IObservableSet<E>, S>() {
			public IObservableSet<E> createObservable(S target) {
