...
public class Properties {
	 ...
	 */
	public static <S, E> IObservableMap<E, ?>[] observeEach(
			IObservableSet<E> domainSet,
			IValueProperty<? super E, ?>[] properties) {
		IObservableMap<E, ?>[] maps = ObservableArrayHelper
				.newIObservableMapArray(properties.length);		for (int i = 0; i < maps.length; i++)
	 ...
	 *         in the given array.
	 */
	public static <K, V> IObservableMap<K, ?>[] observeEach(
			IObservableMap<K, V> domainMap,
			IValueProperty<? super V, ?>[] properties) {
		IObservableMap<K, ?>[] maps = ObservableArrayHelper
				.newIObservableMapArray(properties.length);
